...
// =================== TAREAS MONTAJES - DISEÑO GRAFICO ============
...
const contenedorTareasMt = document.getElementById('contenedor-tareas-mt');

// Contador global para generar IDs únicos
let contadorTareasMt = 1;

// FUNCIÓN PRINCIPAL PARA CREAR TAREAS

function crearTareaMt(id, autoFocus = false) {
    ...
    if (id % 2 === 1) {
        ...
        if (document.getElementById('contenedor-tareas-mt')) {
